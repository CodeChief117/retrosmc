...
# get the addon archive file from github
	  ...
	  wget --no-check-certificate -w 4 -O plugin.program.retrosmc-launcher-0.0.3.tgz https://github.com/CodeChief117/retrosmc/raw/master/plugin.program.retrosmc-launcher-0.0.3.tgz 2>&1 | grep --line-buffered -oP "(\d+(\.\d+)?(?=%))" | dialog --title "Downloading Addon" --gauge "\nPlease wait...\n"  11 70
...
# extract the addon to the kodi addon directory
	  ...
	  (pv -n plugin.program.retrosmc-launcher-0.0.3.tgz | sudo tar xzf - -C /home/osmc/.kodi/addons/ ) 2>&1 | dialog --title "Extracting Addon" --gauge "\nPlease wait...\n" 11 70
...
# download new versions of all scripts and make them executable
            ...
            wget --no-check-certificate -w 4 -O /home/osmc/RetroPie/scripts/retropie.sh.1 https://raw.githubusercontent.com/CodeChief117/retrosmc/master/scripts/retropie.sh
            wget --no-check-certificate -w 4 -O /home/osmc/RetroPie/scripts/retropie.service.1 https://raw.githubusercontent.com/CodeChief117/retrosmc/master/scripts/retropie.service
            wget --no-check-certificate -w 4 -O /home/osmc/install-retrosmc.sh.1 https://raw.githubusercontent.com/CodeChief117/retrosmc/master/install-retrosmc.sh
